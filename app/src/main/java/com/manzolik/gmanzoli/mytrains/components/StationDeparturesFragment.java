...
public class StationDeparturesFragment extends Fragment {
    ...
    private static final String TAG = StationDeparturesFragment.class.getSimpleName();
    ...
    public StationDeparturesFragment() {
        // Required empty public constructor
    }


    public static StationDeparturesFragment newInstance(Station station) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_station_departures, container, false);
